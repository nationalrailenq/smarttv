var Datepicker = function(field, options)
{
	...
	this.keydown = function(e,kc)
	{
		...
		alert('Datepicker keycode::' + keycode )
		switch(keycode)
		{
			case VK_LEFT:
				//alert('left');
